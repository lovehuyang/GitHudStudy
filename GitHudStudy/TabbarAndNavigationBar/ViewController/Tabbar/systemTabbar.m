...
- (void)setupAllChildViewControllers
{
    ...
    [self setupChildViewController:homePageVC title:@"工作台" normalImage:[UIImage imageNamed:@"工作台"] selectImage:[UIImage imageNamed:@"工作台1"]];
    self.home = homePageVC;
    
    //
    ForumViewController *mySickerVC = [[ForumViewController alloc] init];
    [self setupChildViewController:mySickerVC title:@"合同管理" normalImage:[UIImage imageNamed:@"合同管理"] selectImage:[UIImage imageNamed:@"合同管理1"]];
